...
export default function EditProfileForm(props: any) {
  ...
  return (
    <form onSubmit={form.onSubmit((values) => props.submitForm(props.data, values))}>
      <TextInput label="Név" placeholder="Név" {...form.getInputProps('name')} />

      <TextInput label="E-mail cím" placeholder="E-mail cím" {...form.getInputProps('email')} />

      <TextInput label="Lakcím" placeholder="Lakcím" {...form.getInputProps('address')} />

      <TextInput label="Munkahely" placeholder="Munkahely" {...form.getInputProps('workplace')} />

      <TextInput label="Telefonszám" placeholder="Telefonszám" {...form.getInputProps('phone')} />
