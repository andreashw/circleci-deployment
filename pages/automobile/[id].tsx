    ...
    <>
      <div className="mx-5">
        ...
        <Grid gutter="xl" className="mb-10">
          <ListDetail
            List="Manufacturer"
            IsiList={data ? data[0]?.AutomobileManufactures.name : undefined}
          />
          ...
          <ListDetail
            List="Body Type"
            IsiList={data ? data[0]?.AutomobileBodyTypes.name : undefined}
          />
          <ListDetail
        ...
        <Grid gutter="xl" className="mb-10">
          <ListDetail
            List="Curb Weight"
            IsiList={data ? (data[0]?.curb_wight as unknown as string) : undefined}
          />
          <ListDetail
            List="Wheel Base"
            IsiList={data ? (data[0]?.wheel_base as unknown as string) : undefined}
          />
...
function AddAutomobile(/*props*/) {
  return (
    <>
      <HeadingTop
        items={[{ title: 'Automobile', href: '/automobile' }, { title: 'Detail Automobile' }]}
      />
